...
function makePlaceholder(label: string): string {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="400" height="225" viewBox="0 0 400 225">
    ...
    <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle"
      font-family="Segoe UI, sans-serif" font-size="16" fill="#1C1F2A">${label}</text>
  </svg>`;
...
const SLIDES = [
  ...
  { id: "s4", title: "Executive Summary", type: "Leadership", thumbnail: makePlaceholder("Exec Summary") },
  { id: "s5", title: "Customer Success Metrics", type: "Support", thumbnail: makePlaceholder("CS Metrics") },
  { id: "s6", title: "Q4 Key Objectives", type: "Leadership", thumbnail: makePlaceholder("Q4 Objectives") },
];
